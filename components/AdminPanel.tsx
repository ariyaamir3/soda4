...
import { SiteContent, ContactMessage, LightColor, BlinkSpeed, ChatMode, FullRegistrationData, DEFAULT_CONTENT } from '../types';
import { getRegistrations, getContactMessages, uploadFile } from '../services/firebase';
import { X, Save, Edit2, Menu, Database, Loader2, Download, Users, Mail, Trash2, Sparkles, Lock, Briefcase, FileText, Info, Eye, Film, Plus, CheckCircle2 } from 'lucide-react';
...
const AdminPanel: React.FC<AdminPanelProps> = ({ content, onSave, onClose }) => {
  ...
  // استیت‌های اصلی (با مقدار پیش‌فرض مطمئن)
